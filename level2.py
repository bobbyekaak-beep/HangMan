...
class Screen7GameplayLevel2(tk.Frame):
    def __init__(self, parent):
        # Mengubah BG utama menjadi gelap (Cyber Dark Theme)
        ...
        # Konfigurasi Progress Bar agar serasi dengan tema gelap
    ...
    def setup_ui(self):
        ...
        self.lbl_level = tk.Label(info_frame, text=f"LEVEL 2 (Kata {self.indeks_kata_sekarang + 1}/{len(self.daftar_kata)})", bg="#1F2937", font=("Arial", 12, "bold"), fg="#FF8C00")
        ...
        # ── 6. KEYBOARD A–Z (Cyber Dark Keys) ─────────────────────
...
# ── BAGIAN WRAPPER RUN MOCK (UNTUK DI-TEST LANGSUNG) ─────────────────
